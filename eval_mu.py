...
if __name__ == "__main__":
    ...
    mu, sigma = algorithm.eval_mu(val_loader, test_loader)
    d_name = cfg.DATASET.TARGET_DOMAINS
    d_name = d_name[0]
    print(d_name)
    print(mu.shape)
    np.save('D:/Med/DGDR/stat/mu_{}.npy'.format(d_name), mu)
    print(sigma.shape)
    np.save('D:/Med/DGDR/stat/sigma_{}.npy'.format(d_name), sigma)
